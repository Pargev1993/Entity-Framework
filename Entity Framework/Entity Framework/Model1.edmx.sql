...
-- --------------------------------------------------
-- Date Created: 02/20/2019 11:48:25
-- Generated from EDMX file: C:\Users\pqoal\Source\Repos\Entity-Framework\Entity Framework\Entity Framework\Model1.edmx
-- --------------------------------------------------
...
CREATE TABLE [dbo].[YerevanMallKFCSupplier1] (
    [YerevanMallKFCSupplier1_Supplier_Id] int  NOT NULL,
...
CREATE TABLE [dbo].[RIOKFCSupplier1] (
    [RIOKFCSupplier1_Supplier_Id] int  NOT NULL,
...
-- Creating primary key on [YerevanMallKFCSupplier1_Supplier_Id], [Suppliers_Id] in table 'YerevanMallKFCSupplier1'
ALTER TABLE [dbo].[YerevanMallKFCSupplier1]
ADD CONSTRAINT [PK_YerevanMallKFCSupplier1]
    PRIMARY KEY CLUSTERED ([YerevanMallKFCSupplier1_Supplier_Id], [Suppliers_Id] ASC);
GO
...
-- Creating primary key on [RIOKFCSupplier1_Supplier_Id], [Suppliers1_Id] in table 'RIOKFCSupplier1'
ALTER TABLE [dbo].[RIOKFCSupplier1]
ADD CONSTRAINT [PK_RIOKFCSupplier1]
    PRIMARY KEY CLUSTERED ([RIOKFCSupplier1_Supplier_Id], [Suppliers1_Id] ASC);
GO
...
-- Creating foreign key on [YerevanMallKFCSupplier1_Supplier_Id] in table 'YerevanMallKFCSupplier1'
ALTER TABLE [dbo].[YerevanMallKFCSupplier1]
ADD CONSTRAINT [FK_YerevanMallKFCSupplier1_YerevanMallKFC]
    FOREIGN KEY ([YerevanMallKFCSupplier1_Supplier_Id])
    REFERENCES [dbo].[YerevanMallKFCs]
        ([Id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
GO
...
-- Creating foreign key on [RIOKFCSupplier1_Supplier_Id] in table 'RIOKFCSupplier1'
ALTER TABLE [dbo].[RIOKFCSupplier1]
ADD CONSTRAINT [FK_RIOKFCSupplier1_RIOKFC]
    FOREIGN KEY ([RIOKFCSupplier1_Supplier_Id])
    REFERENCES [dbo].[RIOKFCs]
        ([Id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
GO
